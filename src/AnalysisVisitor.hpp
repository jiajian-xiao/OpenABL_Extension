...
struct AnalysisVisitor : public AST::Visitor {
  ...
  void enter(AST::ArrayCreationExpression &);
  ...
  void enter(AST::ConflictResolutionStatement &);
  ...
  void leave(AST::ArrayCreationExpression &);
  ...
  void leave(AST::ConflictResolutionStatement &);
